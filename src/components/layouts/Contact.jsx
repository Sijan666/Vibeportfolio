...
const Contact = () => {
    return (
        <section id="contact" className="py-24 bg-[#020617] relative border-t border-white/5">
            ...
            <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-[#0ea5e9]/10 rounded-full blur-[120px] -z-10"></div>
            <Container>
                <Flex className="flex-col md:flex-row gap-12 md:gap-20">
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:contact@example.com" className="text-white font-medium hover:text-[#0ea5e9] transition-colors">
                        ...
                        <div className="mt-10 flex gap-4">
                            ...
                            {/* <a href="#" className="w-10 h-10 border border-white/10 rounded-full flex items-center justify-center text-gray-400 hover:bg-[#0ea5e9] hover:text-white hover:border-[#0ea5e9] transition-all duration-300">
                    ...
                    <div className="w-full md:w-1/2 bg-[#1e293b]/20 border border-white/5 p-8 md:p-10 rounded-3xl backdrop-blur-sm">
                        <form className="space-y-6">
                            ...
                            <div>
                                <label className="text-white text-sm font-medium mb-2 block">Your Email</label>
                                <input 
                                    type="email" 
                            ...
                            <button className="w-full bg-[#0ea5e9] text-white font-bold py-3.5 rounded-lg hover:bg-[#0284c7] transition-all duration-300 shadow-[0_0_15px_rgba(14,165,233,0.3)]">
                                Send Message
                            </button>
                        </form>
                    </div>
